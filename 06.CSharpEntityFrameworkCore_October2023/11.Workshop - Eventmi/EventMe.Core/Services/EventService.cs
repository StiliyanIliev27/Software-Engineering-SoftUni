...
namespace EventMe.Core.Services
{
    public class EventService : IEventService
    {
        ...
        public EventService(IRepository eventRepository)
        {
        ...
        {
            Event? ev = await eventRepository.GetById<Event>(id);
        ...
        public async Task<EventModel> GetByIdAsync(int id)
        {
            ...
            if(ev == null)
            {
                throw new ArgumentException("Събитието не същестува!");
            }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<TownModel>> GetTownAsync()
        {
            return await eventRepository
                .AllReadOnly<Town>()
