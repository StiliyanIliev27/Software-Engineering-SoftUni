...
SELECT
	c.Id
	,c.[Name] AS Client
	,CONCAT(StreetName, ' ', StreetNumber, ',', ' ', City, ',', ' ', PostCode, ',', ' ', co.[Name]) AS [Address]
FROM Clients c
...
--In this case the function should return 3 as a result
...
--In this case we search the full information about France
