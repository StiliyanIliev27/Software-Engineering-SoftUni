        ...
        public void Run()
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    else if (input[0] == "AddUniversity")//done
                    {
                    ...
                    else if (input[0] == "AddStudent")//done
                    {
                    ...
                    else if (input[0] == "ApplyToUniversity")//TODO
                    {
                    ...
                    else if (input[0] == "UniversityReport")//TODO
                    {
